...
# Import raw data
cast_crew_photos = pd.read_parquet("C:/Users/Lucas/Desktop/letterboxd/data/raw/cast_crew_photos.parquet")
cast_data = pd.read_parquet("C:/Users/Lucas/Desktop/letterboxd/data/raw/cast_data.parquet")
crew_data = pd.read_parquet("C:/Users/Lucas/Desktop/letterboxd/data/raw/crew_data.parquet")
userDiary = pd.read_parquet("C:/Users/Lucas/Desktop/letterboxd/data/raw/userDiary.parquet")
userFilms = pd.read_parquet("C:/Users/Lucas/Desktop/letterboxd/data/raw/userFilms.parquet")
countries_data = pd.read_parquet("C:/Users/Lucas/Desktop/letterboxd/data/raw/countries_data.parquet")
languages_data = pd.read_parquet("C:/Users/Lucas/Desktop/letterboxd/data/raw/languages_data.parquet")
genres_data = pd.read_parquet("C:/Users/Lucas/Desktop/letterboxd/data/raw/genres_data.parquet")
films_data = pd.read_parquet("C:/Users/Lucas/Desktop/letterboxd/data/raw/films_data.parquet")
films_poster = pd.read_parquet("C:/Users/Lucas/Desktop/letterboxd/data/raw/films_poster.parquet")
...
# Add a new column 'person_lboxd_url' by concatenating the base URL with the 'name_query' column
cast_data['person_lboxd_url'] = "https://letterboxd.com" + cast_data['name_query'].str.replace(' ', '')
crew_data['person_lboxd_url'] = "https://letterboxd.com" + crew_data['name_query'].str.replace(' ', '')
...
# Save to JSON file
prontoMovies = calculate_list_watched_percentages(userFilms, pronto_pinarello_queries)
...
# Select columns
positive_diff = positive_diff[['user', 'movie', 'avg', 'rating']]
negative_diff = negative_diff[['user', 'movie', 'avg', 'rating']]
...
start = 'hard-to-kill'
end = 'final-destination-5'
pronto_pina_queries_2024 = pronto_pinarello_queries[
    pronto_pinarello_queries.index(start):pronto_pinarello_queries.index(end) + 1
]
...
top_movies = top_movies[['user', 'movie', 'rating']]
...
top_releases = top_releases[['user', 'movie', 'rating']]
...
weekly_summary = (
    ...
    .agg(
        ...
        avg_weekly_rating=('rating', 'mean')  # Calculate average rating
    )
)
