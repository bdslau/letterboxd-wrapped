...
function drawCharts() {
    ...
    fetch('../docs/best_pic_winners.json')
        .then(response => {
    ...
    fetch('../docs/top_releases_resumitos.json')
        .then(response => {
    ...
    fetch('../docs/top_movies_resumitos.json')
        .then(response => {
    ...
    fetch('../docs/top_stream_resumitos.json')
        .then(response => {
