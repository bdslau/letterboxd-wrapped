...
function drawCharts() {
    ...
    fetch('https://raw.githubusercontent.com/bdslau/letterboxd-wrapped/refs/heads/main/assets/docs/best_pic_winners.json')
        .then(response => {
    ...
    fetch('https://raw.githubusercontent.com/bdslau/letterboxd-wrapped/refs/heads/main/assets/docs/top100_Arg.json')
        .then(response => {
    ...
    fetch('https://raw.githubusercontent.com/bdslau/letterboxd-wrapped/refs/heads/main/assets/docs/top_releases_resumitos.json')
        .then(response => {
    ...
    fetch('https://raw.githubusercontent.com/bdslau/letterboxd-wrapped/refs/heads/main/assets/docs/top_movies_resumitos.json')
        .then(response => {
    ...
    fetch('https://raw.githubusercontent.com/bdslau/letterboxd-wrapped/refs/heads/main/assets/docs/top_stream_resumitos.json')
        .then(response => {
    ...
    fetch('https://raw.githubusercontent.com/bdslau/letterboxd-wrapped/refs/heads/main/assets/docs/user_ratings.json')
    .then(response => {
