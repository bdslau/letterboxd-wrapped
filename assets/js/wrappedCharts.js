...
function drawCharts() {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/user_days.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/user_topReleases.json')
        .then(response => {
    ...
    // PLOT: Display stats
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/display_stats.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/user_topAllMovies.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/user_weekly_data.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/genresWatched_data.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/genresRated_data.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/countriesWatched_data.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/countriesRated_data.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/languagesWatched_data.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/languagesRated_data.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/actors_watched.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/actors_rated.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/directors_watched.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/directors_rated.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/ratings_data.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/releasesProportion.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/positive_diff.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/negative_diff.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/high_low_data.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/prontoMovies.json')
        .then(response => {
    ...
    fetch('https://bdslau.github.io/letterboxd-wrapped/assets/docs/all_countries.json')
        .then(response => {
...
function movieMap(user_data) {
    ...
    const maxCount = Math.max(https://bdslau.github.io/letterboxd-wrapped/assets.Object.values(countryWatchCount), 1);
